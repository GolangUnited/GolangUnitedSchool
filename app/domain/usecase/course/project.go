...
func (u *ProjectUsecase) GetProjectsByCourseId(
	ctx context.Context,
	courseId int64) ([]model.Project, error) {
	panic("not implemented")
}

func (u *ProjectUsecase) GetProjectsByGroupId(
	ctx context.Context,
	groupId int64) ([]model.Project, error) {
	panic("not implemented")
}
...
func (u *ProjectUsecase) CreateProject(
	ctx context.Context,
